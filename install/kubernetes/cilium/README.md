...
| dnsPolicy | string | `""` | DNS policy for Cilium agent pods. Note that Cilium sets the DNS policy to ClusterFirstWithHostNet regardless of this setting in managed etcd mode (i.e. etcd.managed==true && etcd.k8sService==false) Ref: https://kubernetes.io/docs/concepts/services-networking/dns-pod-service/#pod-s-dns-policy |
...
| operator.dnsPolicy | string | `""` | DNS policy for Cilium operator pods. Note that Cilium sets the DNS policy to ClusterFirstWithHostNet regardless of this setting in managed etcd mode (i.e. etcd.managed==true && etcd.k8sService==false) Ref: https://kubernetes.io/docs/concepts/services-networking/dns-pod-service/#pod-s-dns-policy |
