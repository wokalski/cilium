		...
		cache.ResourceEventHandlerFuncs{
			AddFunc: func(obj interface{}) {
				...
				if cnp := k8s.ObjToSlimCNP(obj); cnp != nil {
					...
					resource := ipcacheTypes.NewResourceID("ccnp", cnp.ObjectMeta.Namespace, cnp.ObjectMeta.Name)
			...
			UpdateFunc: func(oldObj, newObj interface{}) {
				...
				if oldCNP := k8s.ObjToSlimCNP(oldObj); oldCNP != nil {
					if newCNP := k8s.ObjToSlimCNP(newObj); newCNP != nil {
						...
						resource := ipcacheTypes.NewResourceID("ccnp", newCNP.ObjectMeta.Namespace, newCNP.ObjectMeta.Name)
